...
public class MeshDestroy : MonoBehaviour
{
    ...
    private void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            parts[i].GameObject.GetComponent<Rigidbody>().AddForceAtPosition(parts[i].Bounds.center * ExplodeForce, new Vector3(1, 0, 0));
        }
    ...
    public class PartMesh
    {
        ...
        {            
            ...
            rigidbody.mass = original.GetComponent<Rigidbody>().mass;
            var meshDestroy = GameObject.AddComponent<MeshDestroy>();
            var tagMesh = GameObject.gameObject.tag = "Box";
